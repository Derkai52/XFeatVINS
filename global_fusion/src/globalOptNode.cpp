...
void vio_callback(const nav_msgs::Odometry::ConstPtr &pose_msg)
{
    ...
    Eigen::Vector3d linear_xyz(global_t.x(), global_t.y(), global_t.z());
    ...
    odometry.pose.pose.position.x = rotated_vec[0];
    odometry.pose.pose.position.y = rotated_vec[1];
    odometry.pose.pose.position.z = rotated_vec[2];
